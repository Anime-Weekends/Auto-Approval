...
async def start_command(_, m: Message):
    ...
    keyboard = InlineKeyboardMarkup([
        ...
        [
            InlineKeyboardButton("⤬ Kɪᴅɴᴀᴘᴘ ᴍᴇ ʙᴀʙʏ ⤬", url="https://t.me/{cfg.BOT_USERNAME}?startchannel=true"), 
            InlineKeyboardButton("⤬ Kɪᴅɴᴀᴘᴘ ᴍᴇ ʙᴀʙʏ ⤬", url="https://t.me/{cfg.BOT_USERNAME}?startgroup=true")
        ],
        [
